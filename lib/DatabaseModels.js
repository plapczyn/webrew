...
class _Coffee extends _BaseCollection {
  constructor(coffeeBrand, coffeeName, coffeeRoast, coffeeDescription, imageUrl, createdAt, coffeeOwner, username, averageRating, _id){
  ...
  _constructor(advancedRebrew){
    Object.keys(advancedRebrew).forEach((e) => {
      switch (e.toLowerCase()) {
        ...
        break;      
        case 'coffeebrand':
        this.CoffeeBrand = advancedRebrew[e];
        break;
        case 'coffeename':
...
class _Rebrew extends _BaseCollection {
  constructor(coffeeId, coffeeBrand, coffeeName, rebrew, rating, title, reviewDate, owner, user, _id){
